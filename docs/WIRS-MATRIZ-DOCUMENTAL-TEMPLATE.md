...
| `docs/ENTENDENDO-O-WIRS.md` | Didático | como/por que detecções entregues funcionam | informativa baseada em entrega | atual | preservar/revisar | não | não | código + Issues done | usuários/analistas | detecção entregue | preencher | preencher | preencher |
