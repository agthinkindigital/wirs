...
Última revisão: 2026-09-15 · branch `develop` · commit `5175b75`
...
| `ESTADO_ORQUESTRATOR.md` | Snapshot | Estado operacional momentâneo | Informativa | Atual | Regenerado | Não | Não | GitHub + checkout | Nenhum | Fim/início de DAG | Data/branch/commit e próximos passos obsoletos | Snapshot atualizado sem acumular histórico | 2026-09-15 |
...
| GitHub slice Issues | Tracker | Comportamento verificável | Normativa de entrega | A-E | Realinhado | Não acima da Epic | Sim | Epic + docs do módulo | Código/testes/docs | Implementação ou dependência muda | Test paths mortos e blockers laterais | Bodies, labels e blockers corrigidos | 2026-09-15 |
| Código + testes reproduzíveis | Prova de implementação | O que realmente funciona | Autoridade factual | Atual | Referência | Não | Não | Spec/Issues | README, State, audit | Código/teste muda | Canonical/YARA/content analysis incompletos | Registrado como dívida, sem fingir implementação | 2026-09-15 |
